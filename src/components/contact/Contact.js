              ...
              <form onSubmit={handleSubmit}>
                ...
                {formData.cita === 'Inicio de Carpeta' &&
                  <div className='border-form'>
                    <p className='d-tra'>Datos de tramite</p>
                  ...
                  <div className='border-form'>
                    ...
                    <div className='modal-name2' style={{ marginTop: '15px' }}>
                      ...
                      <select
                        ...
                        name='parte_in'
                        onChange={updateInput}
                        value={formData.parte_in || ''}
                      >
                        <option name='parte_in' />
                ...
                <button className='button-ma' type='submit'>Enviar</button>
              </form>
            </div>
          </div>
        </div>
