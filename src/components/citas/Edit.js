      ...
      <div class="container-e">
        <div class="panel panel-default">
          <div class="panel-body">
            <div class="btn">Agregar hora de cita</div>
            <form onSubmit={this.onSubmit} style= {{marginLeft: '15px', marginTop: '30px'}}>
              <div class="form-group">
                <label for="nombre" className='ca'>Nombre:</label>
                <input type="text" class="form-control" name="nombre" value={this.state.nombre} onChange={this.onChange} placeholder="Nombre" disabled/>
              </div>
              <div class="form-group">
                <label for="email" className='ca'>Email:</label>
                <input type="text" class="form-control" name="email" value={this.state.email} onChange={this.onChange} placeholder="Email" disabled/>
              </div>
              <div class="form-group">
                <label for="cel" className='ca'>Telefono:</label>
                <input type="text" class="form-control" name="cel" value={this.state.cel} onChange={this.onChange} placeholder="Telefono" disabled/>
              </div>
              <div class="form-group">
